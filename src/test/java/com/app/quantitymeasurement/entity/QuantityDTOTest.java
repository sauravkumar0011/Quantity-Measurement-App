 ...
 * QuantityDTOTest
 *
 * Tests the QuantityDTO data transfer object: - Enum-based constructor
 * populates value, unit, and measurementType correctly - String-based
 * constructor stores raw values as-is - Getters return the stored values -
 * toString produces the expected format - Inner unit enums expose correct names
 * and measurement types - IMeasurableUnit contract is satisfied by all inner
 * enums
 */
public class QuantityDTOTest {
	...
	public void testGetMeasurementType_ReturnsType() {
		assertEquals("WeightUnit", new QuantityDTO(1.0, QuantityDTO.WeightUnit.KILOGRAM).getMeasurementType());
	}
